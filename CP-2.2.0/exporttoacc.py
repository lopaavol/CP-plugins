...
__doc__ = '''
<b>Export To ACC</b> exports measurements into one or more files that can be
opened in Advanced Cell Classifier.
<hr>
...
class ExportToACC(cpm.CPModule):
    ...
    def visible_settings(self):
        ...
        result = [self.directory, self.file_image_name]
    ...
    def make_image_file_name(
        ...
        print("in make_image_file_name() imagename {}".format(imagename))
        filename = "%s.%s" % (os.path.splitext(imagename)[0], self.extension())
    ...
    def make_object_file(self, object_names, image_set_numbers, workspace,
        ...
        for img_number in image_set_numbers:
            ...
            try:
                ...
                print('columns (425) {}'.format(columns))
